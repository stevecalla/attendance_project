...
// const GOOGLE_CLOUD_ACCOUNT = process.env.GOOGLE_CLOUD_ACCOUNT_EZHIRE;
// const GOOGLE_CLOUD_PROJECT_ID = process.env.GOOGLE_CLOUD_PROJECT_ID_EZHIRE;

const GOOGLE_CLOUD_ACCOUNT = process.env.GOOGLE_CLOUD_ACCOUNT_CALLA;
const GOOGLE_CLOUD_PROJECT_ID = process.env.GOOGLE_CLOUD_PROJECT_ID_CALLA;

// LOGIN TO THE GOOGLE CLOUD ACCOUNT
async function execute_google_cloud_command(action, log_message, log_file_name) {
    // console.log(action);
    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            exec(command, (error, stdout, stderr) => {
                ...
                // GENERATE LOG FILE FOR SUCCESS
                generateLogFile(log_file_name, `${log_message} ${stdout} ${stderr}`);
...
// execute_google_cloud_command("login", "Login successful", "login_to_google_cloud");
// execute_google_cloud_command("set_property_id", "Project Id set successfully.", "set_project_id_for_google_cloud");
